...
--
myWorkspaces    = [" \xf0ac "," \xf1cb "," \xf1fb "," \xf0c3 "," \xf03e "," \xf03d "," \xf26c "," \xf07c "," \xf252 "]

-- Border colors for unfocused and focused windows, respectively.
--
myNormalBorderColor  = "#cdd6f4"
myFocusedBorderColor = "#12efef"
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- launch a terminal
    [ ((modm,               xK_Return), spawn "emacsclient -c -a 'emacs'")

    -- launch emacs
    , ((modm .|. shiftMask, xK_t     ), spawn $ XMonad.terminal conf)

    -- brave browser
    , ((modm .|. shiftMask, xK_x     ), spawn "firefox")
...
myStartupHook = do
    ...
    spawn "killall polybar; polybar bar1 | polybar bar1-bottom | polybar bar2 | polybar bar2-bottom"
------------------------------------------------------------------------
...
--main = do
--  xmproc <- spawnPipe "polybar mainbar-xmonad | polybar secondarybar-xmonad"
